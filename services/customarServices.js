...
exports.getCustomars = asyncHandler(async (req, res, next) => {
    ...
    const customars = await customarsModel.find();
...
exports.updataCustomar = asyncHandler(async (req, res, next) => {
    ...
    const customar = await customarsModel.findByIdAndUpdate(id, req.body, { new: true });
...
exports.deleteCustomar = asyncHandler(async (req, res, next) => {
    ...
    const customar = await customarsModel.findByIdAndUpdate(id, { archives: "true" }, { new: true });
