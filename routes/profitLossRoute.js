...
const { getAllActiveProductsValues } = require("../services/activeProductsValuesServices");
...
profitLossRoute.route("/activeProductsValues").get(getAllActiveProductsValues);
